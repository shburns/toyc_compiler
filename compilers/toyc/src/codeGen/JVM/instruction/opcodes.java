...
public final static int LDC_QUICK                 = 203;

public final static int LDC2_QUICK                = 205;
public final static int GETFIELD_QUICK            = 206;
public final static int PUTFIELD_QUICK            = 207;
public final static int GETFIELD2_QUICK           = 208;
public final static int PUTFIELD2_QUICK           = 209;

public final static int PUTSTATIC_QUICK           = 211;
public final static int GETSTATIC2_QUICK          = 212;
public final static int PUTSTATIC2_QUICK          = 213;
public final static int INVOKEVIRTUAL_QUICK       = 214;
public final static int INVOKENONVIRTUAL_QUICK    = 215;
public final static int INVOKESUPER_QUICK         = 216;
public final static int INVOKESTATIC_QUICK        = 217;
public final static int INVOKEINTERFACE_QUICK     = 218;
public final static int INVOKEVIRTUALOBJECT_QUICK = 219;

public final static int NEW_QUICK                 = 221;
public final static int ANEWARRAY_QUICK           = 222;
public final static int MULTIANEWARRAY_QUICK      = 223;
public final static int CHECKCAST_QUICK           = 224;
public final static int INSTANCEOF_QUICK          = 225;
public final static int INVOKEVIRTUAL_QUICK_W     = 226;
public final static int GETFIELD_QUICK_W          = 227;
public final static int PUTFIELD_QUICK_W          = 228;
